...
trait IUserAuth<TContractState> {
    // User Registration
    fn register_user(
        ref self: TContractState, username: felt252, display_name: felt252, email_hash: felt252,
    ) -> bool;

    // Login/Logout
    fn login(
        ref self: TContractState, signature: Array<felt252>, message_hash: felt252, nonce: u64,
    ) -> felt252;
    ...
    // Profile Management
    fn update_profile(ref self: TContractState, display_name: felt252, email_hash: felt252) -> bool;
    ...
    fn set_recovery_address(
        ref self: TContractState, recovery_address: starknet::ContractAddress,
    ) -> bool;
